...
export default function Song(props){
    ...
    const deleteSong = (e) => {
        ...
        axios.delete(`/api/songs/${props.settedSong.id}`)
            .then(res => {
                if(res.data.err){console.log(res.data.message); return}
                props.getSongs();
    ...
    return(
        <div className={(songPlaying.songUrl === song.songUrl) ? 'Song playing':'Song'} onClick={playSong}>
